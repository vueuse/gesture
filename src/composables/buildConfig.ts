...
export function _buildMoveConfig({
  ...
  const opts: InternalConfig = getInternalGenericOptions({
    domTarget,
    eventOptions,
    window,
    enabled,
...
export function _buildHoverConfig({
  domTarget,
  eventOptions,
  window,
  enabled,
...
export function _buildDragConfig({
  domTarget,
  eventOptions,
  window,
  enabled,
...
export function _buildPinchConfig({
  domTarget,
  eventOptions,
  window,
  enabled,
...
export function _buildScrollConfig({
  domTarget,
  eventOptions,
  window,
  enabled,
...
export function _buildWheelConfig({
  domTarget,
  eventOptions,
  window,
  enabled,
